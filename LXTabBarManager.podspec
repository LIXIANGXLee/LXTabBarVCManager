#
#  Be sure to run `pod spec lint LXTabBarManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  LXTabBarManager is manager
                   DESC

  spec.homepage     = "https://github.com/LIXIANGXLee/LXTabBarVCManager"
  ...
  spec.source       = { :git => "https://github.com/LIXIANGXLee/LXTabBarVCManager.git", :tag => "#{spec.version}" }
